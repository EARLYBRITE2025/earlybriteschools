        ...
        <div className="flex flex-col items-center gap-10 lg:hidden">
          <div className="text-white text-center">
            ...
            <p className="text-[18px] mb-4">
              Many students enter higher education unsure of their purpose or
              direction. The Earlybrite Gap Year Program helps bridge that gap
              by equipping them with maturity, exposure, and clarity.
            </p>
            <p>
              Learners who complete the program often step into university life
              more confident, independent, and ready to lead.
            </p>
          </div>
          <div className="relative w-full">
            <Image
              src="/images/inverted-layer.png"
              width={400}
              height={300}
              alt="Background"
              className="absolute w-full top-20  left-0 z-[1]"
            />
            <Image
            ...
            />
            <button className="absolute top-10 left-24 -translate-x-1/2 bg-[#1A94D2] w-fit reuseable-button text-white z-[3]">
        ...
        <div className="hidden lg:flex items-end justify-between gap-10">
          <div className="relative">
            ...
            <Image
              ...
              width={550}
              height={550}
              className="relative z-10 w-[500px] mt-[100px]"
            />
          </div>
          ...
          <div className="text-white max-w-[539px] py-16">
            ...
            <div className="flex items-center gap-3">
              ...
              <button className="bg-[#F9BB1E] w-fit reuseable-button text-black">
                <span className="flex items-center justify-center gap-2">
