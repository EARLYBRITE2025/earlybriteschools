...
const AboutUs = () => {
  return (
    <div className='flex items-center justify-center p-[40px] flex-col' id="about">
      ...
      <p className="text-[#666666] xl:w-[660px] xl:text-[18px]">
           Our approach is backed by partnerships and global education frameworks that ensure every learner's journey meets orld-class standards.
      </p>
