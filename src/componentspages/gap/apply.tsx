      ...
      <div className="w-full 3xl:max-w-[1400px] px-7 xl:px-28 3xl:px-0">
        ...
        <div className="flex flex-col items-center gap-10 lg:hidden">
          <p className="text-white  font-bold text-center">
            Every part of the program is designed to make your child&apos;s
            experience relevant, future-ready, and globally recognized.
          </p>
          <button className="bg-[#F9BB1E] reuseable-button w-fit text-black">
          ...
          <div className="flex flex-col gap-3 w-full">
            <div className="bg-white flex rounded-[12px] p-6 gap-3">
              ...
              />
              <p>
                Turn idle time into meaningful learning and real-world
                experience.
              </p>
            </div>
            <div className="bg-white flex rounded-[12px] p-6 gap-3">
              ...
              />
              <p>
                Build 21st-century skills like communication, teamwork, and
                creativity.
              </p>
            </div>
            <div className="bg-white flex rounded-[12px] p-6 gap-3">
            ...
            <div className="bg-white flex rounded-[12px] p-6 gap-3">
              ...
              />
              <p>
                Connect learners to internship, community, and global networks.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="hidden lg:flex items-center justify-between gap-10">
          ...
          <div className="flex flex-col gap-4">
            <div className="bg-white flex rounded-[12px] p-10 gap-3">
              <Image
                src="/images/check-green.svg"
                width={24}
                height={24}
