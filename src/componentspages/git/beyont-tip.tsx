...
const BeyondTip = () => {
  return (
    <>
      <section className="bg-[#1A94D2] items-center flex justify-center flex-col p-5 md:p-10 gap-10 md:hidden">
        <div className="flex flex-col text-[#FFFFFF] gap-4">
          <h1 className="text-[36px] font-bold font-(family-name:--font-baloo2) ">
            Beyond the Trip
          </h1>
          <p className="text-[18px]">
            Every GIT participant continues their development through
            Earlybrite&apos;s Elite Mentorship Program (TEMP), a structured
            30-month roadmap that ensures their global learning becomes lifelong
            growth.
          </p>
        ...
        <div className="w-[322px] bg-[#FFE5A2] rounded-2xl flex flex-col  items-center  justify-start  h-[600px] md:hidden xl:flex">
          <h1 className="text-[#000000] pl-5 w-[220px] text-[36px] font-bold font-(family-name:--font-baloo2) md:hidden xl:flex">
            What this includes
          </h1>
      ...
      <section className="relative hidden md:flex items-start justify-center bg-[#7EB6E8] min-h-[800px] p-10">
        {/* White stripe pattern background */}
        <div className="absolute w-[300px] bottom-0 inset-0">
          <Image
            src="/images/beyond-the-trip-bg.png"
            fill
            alt=""
        ...
        <div className="relative z-10 w-full max-w-[1200px] mx-auto">
          ...
          <div className="flex justify-between items-start">
            ...
            <div className="flex flex-col text-[#FFFFFF] gap-4 max-w-[454px]">
              <h1 className="text-[40px] font-bold font-(family-name:--font-baloo2)">
                Beyond the Trip
              </h1>
              <p className="text-[18px]">
                Every GIT participant continues their development through
            ...
            <div className="bg-[#FFE5A2] rounded-2xl flex flex-col py-10 px-10 items-start justify-center gap-6 w-[550px]">
              <h1 className="text-[#000000] text-[36px] font-bold font-(family-name:--font-baloo2)">
                What this includes
              </h1>
