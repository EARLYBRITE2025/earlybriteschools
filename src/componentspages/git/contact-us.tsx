...
const ContactUs = () => {
  ...
  <div className='xl:bg-gradient-to-r from-[#E1F5FE] to-[#FFF0CC] xl:flex xl:items-center xl:justify-center xl:p-[45px]' id='contact'>
     ...
     <div className='w-[322px] flex flex-col gap-[40px]  '>
        ...
        <p className='text-white xl:text-[21.23px] xl:w-[508]' >The world is changing fast, but the right experience can prepare your child for life. Join the Earlybrite Global
             Innovation Trek and let your child learn, explore, and grow with purpose.</p>
               <div className='flex items-center xl:space-x-3 w-full justify-center whitespace-nowrap md:items-center' >
                       ...
                       <button className='bg-[#1A94D2] ] reuseable-button text-white w-[169.70px] '><span className='flex  items-center group justify-center text-white'>
                       Partner with us<WhiteRightarrowSvg /> </span></button>
              </div>
