      ...
      <div className="w-full 3xl:max-w-[1400px] px-7 xl:px-28 3xl:px-0">
        <div className=" flex flex-col xl:flex-row items-start justify-between gap-8">
          ...
          <div className="xl:w-[50%] w-full">
            ...
            <p className="text-[#101010E5] text-[18px] mb-6">
              Immaginarium is designed to grow with your child. Each stage
              builds on the last, ensuring that learning feels natural,
            ...
            <div className="space-y-4 mb-8">
              {stages.map((stage, index) => (
                <div key={index} className="bg-[#F9BB1E] rounded-xl p-4">
                  <h3 className="text-[20px] font-bold text-black mb-2 font-[family-name:var(--font-baloo2)]">
                    {stage.title}
                  </h3>
