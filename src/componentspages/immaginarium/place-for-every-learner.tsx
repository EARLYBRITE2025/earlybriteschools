      ...
      <div className="w-full 3xl:max-w-[1400px] px-7 xl:px-28 3xl:px-0">
        <div className="">
          ...
          <div className="flex flex-col xl:flex-row justify-between items-start xl:items-center mb-8">
            ...
            <div className="xl:text-right mt-4 lg:flex flex-col justify-end items-end xl:mt-0">
              <p className="text-[#101010E5] text-[16px] lg:w-[50%] mb-4">
                To make learning personal and social, children are grouped by
          ...
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
            ...
            <div className="bg-[#BAE6FC] rounded-xl p-6 lg:p-12  flex flex-col justify-between">
              ...
              <h3 className="text-[24px] xl:text-[48px] font-bold text-black mb-2 font-[family-name:var(--font-baloo2)]">
                Bright Explorers (Ages 2–6)
              </h3>
              <p className="text-[14px] text-[#101010E5] mb-4">
                Blends discovery and guided making through crafts, music, and
                stories.
              </p>
              <Image
            ...
            {/* Future Makers Card */}
            <div className="bg-[#F9BB1E] rounded-xl p-6 lg:p-12 flex flex-col justify-between">
              <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center mb-4">
                <Image
                  src="/images/safe.png"
                  width={20}
              ...
              <p className="text-[14px] text-[#101010E5] mb-4">
                Encourages creativity, teamwork, and design thinking through
                hands-on projects.
              </p>
              <Image
