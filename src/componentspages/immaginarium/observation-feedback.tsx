  ...
  return (
    <section className="w-full bg-white py-16 flex justify-center">
      <div className="w-full 3xl:max-w-[1400px]  xl:px-28 3xl:px-0">
        <div className="">
          <div className="bg-[#009147] rounded-[24px] p-4 py-8 xl:p-12 flex flex-col xl:flex-row items-stretch justify-between gap-8">
            {/* Left content */}
            <div className="xl:w-[40%]">
              ...
              <p className="text-white text-[14px] mb-6">
                Every child&apos;s journey is documented through observation and
                reflection inspired by the Reggio Emilia and Anji Play methods.
                Parents receive monthly feedback reports highlighting growth in
                creativity, confidence, collaboration, and curiosity.
              </p>
            ...
            {/* Right image */}
            <div className="xl:w-[55%] relative min-h-[450px]">
              <Image
