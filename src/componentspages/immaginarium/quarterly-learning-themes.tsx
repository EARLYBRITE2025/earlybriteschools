    ...
    <section className="w-full bg-[#FFE5A2] py-16 flex justify-center">
      <div className="w-full 3xl:max-w-[1400px] px-7 xl:px-28 3xl:px-0">
        <div className="">
          ...
          <div className="flex flex-col xl:flex-row justify-between gap-8 mb-12">
            ...
            <div className="xl:w-[40%]">
              ...
              <p className="text-[#101010E5] text-[14px] mb-6">
                Each quarter in Immaginarium follows a themed journey that
                nurtures curiosity, creativity, and confidence. Every session is
                inspired by international early learning models and real-world
                exploration.
              </p>
              ...
              <ul className="space-y-2">
                <li className="flex items-start gap-2">
                  <Image
                    ...
                    className="mt-1"
                  />
                  <span className="text-[14px] text-[#101010E5]">
                    IB Primary Years Programme (PYP) inquiry model
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <Image
                ...
                <li className="flex items-start gap-2">
                  ...
                  />
                  <span className="text-[14px] text-[#101010E5]">
                    UNESCO Early Childhood Development Standards
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="flex justify-between flex-col lg:flex-row gap-6">
              ...
              <div className="lg:w-[45%] space-y-3">
                {quarterIncludes.map((item, index) => (
                  <div
                    key={index}
                    className="bg-[#1A94D2] rounded-lg p-8 lg:w-[95%] flex items-start gap-3"
                  >
                    <Image
                      src="/images/check-green.svg"
                      width={16}
              ...
              {/* Right image */}
              <div className="lg:w-[48%] relative h-[300px] lg:h-auto">
                <Image
          ...
          <div className="mb-12">
            <div className="flex justify-between items-center flex-col lg:flex-row gap-6 py-10">
              {/* Left content */}
              <div className="lg:w-[45%]">
                <h3 className="text-[38px] lg:text-[48px] font-[family-name:var(--font-baloo2)] font-bold text-black mb-4">
                  Quarter 1: Creativity and Discovery
                </h3>
                <p className="text-[#101010E5] text-[16px] lg:text-[18px] mb-2">
                  Focus: Arts and Crafts | Sports and Wellness | Science and
                  Discovery
                </p>
                <p className="text-[#101010E5] text-[16px] lg:text-[18px] mb-4">
                  This quarter sets the tone with curiosity, exploration, and
                  joyful experimentation. Children express creativity, build
                  coordination, and discover the power of questioning and doing.
                </p>
                <p className="text-[#1A94D2] text-[16px] lg:text-[18px] font-semibold mb-4">
                  Global Inspirations:
                </p>
                <ul className="space-y-2">
                  {quarter1Inspirations.map((item, index) => (
                    <li key={index} className="flex items-start gap-2">
                      <Image
                        ...
                        className="mt-1"
                      />
                      <span className="text-[16px] lg:text-[18px] text-[#101010E5]">
                        {item}
                      </span>
                    </li>
                  ))}
              ...
              {/* Right image */}
              <div className="lg:w-[45%] relative h-[400px] w-full lg:h-[500px]">
                <Image
            ...
            <div className="flex justify-between items-center flex-col-reverse lg:flex-row py-10">
              <div className="lg:w-[45%] relative h-[400px] w-full lg:h-[500px]">
                <Image
              ...
              <div className="lg:w-[45%] w-full mb-10 lg:mb-0">
                <h4 className="text-[38px] lg:text-[48px] font-bold text-black mb-2 font-[family-name:var(--font-baloo2)]">
                  Month 1: Arts and Crafts (6 weeks)
                </h4>
                <p className="text-[#101010E5] text-[16px] lg:text-[18px] mb-2">
                  <span className="text-[#1A94D2] font-semibold">Goal:</span>{" "}
                  Explore creativity through hands-on crafts.
                </p>
                <p className="text-[#101010E5] text-[16px] lg:text-[18px] mb-4">
                  Focus: Fine motor skills, imagination, color and texture,
                  creative problem-solving.
                </p>
                <p className="text-[#1A94D2] text-[16px] lg:text-[18px] font-semibold mb-3">
            ...
            <div className="flex justify-between items-center flex-col-reverse lg:flex-row-reverse gap-6 py-10">
              <div className="lg:w-[45%] relative h-[400px] w-full lg:h-[500px]">
                <Image
              ...
              <div className="lg:w-[45%]">
                ...
                <p className="text-[#101010E5] text-[16px] lg:text-[18px] mb-2">
                  <span className="text-[#1A94D2] font-semibold">Goal:</span>{" "}
                  Develop teamwork, discipline, and body confidence.
                </p>
                <p className="text-[#101010E5] text-[16px] lg:text-[18px] mb-4">
                  Focus: Coordination, emotional regulation, cooperation,
                  sportsmanship.
                </p>
                <p className="text-[#101010E5] text-[16px] lg:text-[18px] mb-4">
                  <span className="text-[#1A94D2] font-semibold">
                    Global Inspirations:
                  </span>{" "}
                  Finland&apos;s Fun Fitness Curriculum, Anji Play (China), UK
                  EYFS Physical Development strand.
                </p>
                <p className="text-[#1A94D2] text-[16px] lg:text-[18px] font-semibold mb-3">
                  Experiential Highlights:
                </p>
            ...
            <div className="flex justify-between items-center flex-col-reverse lg:flex-row gap-6 py-10">
              <div className="lg:w-[45%] relative h-[400px] w-full lg:h-[500px]">
                <Image
              ...
              <div className="lg:w-[45%]">
                ...
                <p className="text-[#101010E5] text-[16px] lg:text-[18px] mb-2">
                  <span className="text-[#1A94D2] font-semibold">Goal:</span>{" "}
                  Spark curiosity through observation and experimentation
                </p>
                <p className="text-[#101010E5] text-[16px] lg:text-[18px] mb-4">
                  Focus: Inquiry skills, cause and effect, early STEM literacy.
                  Global Inspirations: Children&apos;s Science Museums
                  (Singapore & UK), HighScope (USA) Plan-Do-Review cycle.
                </p>
                <p className="text-[#1A94D2] text-[16px] lg:text-[18px] font-semibold mb-3">
                  Experiential Highlights:
                </p>
          ...
          <div className="text-center py-8">
            ...
            <p className="text-[#101010E5] text-[16px] max-w-[700px] mx-auto mb-6">
              Children explore talents in arts, sports, and science while
              developing creativity, teamwork, confidence, and curiosity about
              the world.
            </p>
