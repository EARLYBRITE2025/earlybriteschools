  ...
  return (
    <section className='w-full bg-white py-16 flex justify-center'>
      <div className='w-full 3xl:max-w-[1400px] px-7 xl:px-28 3xl:px-0'>
        <div className=''>
        <div className='bg-[#202D60] rounded-[24px] p-8 xl:p-12 flex flex-col xl:flex-row items-stretch justify-between gap-8'>
          {/* Left content */}
          <div className='xl:w-[45%]'>
            ...
            <div className='flex items-center gap-4'>
              ...
              <button className='bg-white text-black px-6 py-3 rounded-full hover:bg-gray-100 transition-all duration-300'>
                Talk to an Advisor
              </button>
            </div>
          </div>
          ...
          {/* Right image */}
          <div className='xl:w-[50%] relative min-h-[400px]'>
            <Image
