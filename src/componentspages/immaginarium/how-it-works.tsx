        ...
        <div className="">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-white text-[16px] max-w-[700px] mx-auto">
              Each Immaginarium experience runs as a 4- to 6-week program
              delivered through weekend sessions that balance structured
              guidance with open exploration.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 mb-10">
            {features.map((feature, index) => (
              <div key={index} className="bg-white rounded-xl p-6 lg:px-10">
          ...
          <div className="text-center mb-8">
            <p className="text-white text-[14px] max-w-[700px] mx-auto mb-6">
              Every child belongs to a vibrant learning community where
              creativity and curiosity are nurtured. Parents are partners in the
              journey and are invited to observe, celebrate, and support their
              child&apos;s growth during showcase weekends.
            </p>

            <h3 className="text-[20px] font-bold text-white mb-4 font-[family-name:var(--font-baloo2)]">
              Monthly + Quarterly Flow
            </h3>
            <p className="text-white text-[14px] max-w-[700px] mx-auto">
              Each month focuses on a unique theme. Every three months form a
              quarterly journey with one overarching developmental focus. Each
              theme concludes with a showcase event, an exhibition or
              performance that allows children to demonstrate learning, build
              confidence, and celebrate progress.
            </p>
          </div>
