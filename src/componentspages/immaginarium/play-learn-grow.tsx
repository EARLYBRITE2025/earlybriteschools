        ...
        <div className=" flex flex-col xl:flex-row items-center justify-between gap-8">
          ...
          <div className="xl:w-[40%] w-full">
            ...
            <p className="text-[#101010E5] text-[16px] mb-4">
              At Earlybrite, we believe play is not the opposite of learning,
              it&apos;s the foundation of it. Every activity in Immaginarium is
              designed to spark curiosity, imagination, and independence.
            </p>
            ...
            <ul className="space-y-3 mb-8">
              <li className="flex items-start gap-3">
                <Image
                  ...
                  className="mt-1"
                />
                <span className="text-[#101010E5] text-[16px]">
                  Anji Play (China): Encouraging self-directed creativity.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <Image
                ...
                />
                <span className="text-[#101010E5] text-[16px]">
                  HighScope (USA): Promoting active learning and initiative.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <Image
                ...
                />
                <span className="text-[#101010E5] text-[16px]">
                  Reggio Emilia (Italy): Using the environment as a teacher.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <Image
                ...
                />
                <span className="text-[#101010E5] text-[16px]">
                  Abecedarian Project (USA): Focusing on long-term learning
                  impact.
                </span>
              </li>
            </ul>
          ...
          {/* Right images */}
          <div className="lg:w-[55%] w-full flex gap-4">
            <div className="w-1/2">
              <Image
                ...
                className="rounded-xl object-cover w-full lg:h-[480px]"
              />
            </div>
            <div className="w-1/2">
              <Image
