  ...
  return (
    <>
      ...
      <section className="flex flex-col mt-10 gap-5 justify-center pt-20 pb-20 items-center w-full gradient md:hidden px-7">
        <h1 className="text-[24px] sm:text-[27.44px] font-bold font-(family-name:--font-baloo2) text-center">
          Programs Overview
        </h1>
          ...
          {featureCards.map((card) => (
            ...
            >
              ...
              <div className="p-4 space-y-2">
                ...
                <Link
                  href="/git"
                  className="button bg-[#1A94D2] text-white text-[14px]"
                >
                  {card.buttonText}
                </Link>
              </div>
        ...
        {featureCards.map((card) => (
          ...
          >
            ...
            <div className="p-4 flex-1 flex flex-col">
              ...
              <Link
                href="/git"
                className="button bg-[#1A94D2] text-white text-[14px] mt-auto"
              >
                {card.buttonText}
              </Link>
            </div>
      ...
      <section className="hidden xl:flex w-full justify-center pt-20 pb-20 bg-[#F2F2F2]">
        <div className="w-full 3xl:max-w-[1400px] px-7 xl:px-28 3xl:px-0 flex flex-col gap-5">
          <h1 className="text-[27.44px] font-bold text-center">Programs Overview</h1>
                ...
                <CarouselItem key={card.id} className="basis-[32%] px-4">
                  <Card className="bg-white rounded-2xl h-[603px] hover:shadow-lg transition w-full overflow-hidden p-0">
                    ...
                    <div className="p-4 flex-1 flex flex-col justify-between">
                      ...
                      <Link
                        href={card.herf}
                        className="button bg-[#1A94D2] text-white mt-auto"
                      >
