    ...
    <section className='w-full bg-black relative overflow-visible flex justify-center'>
      <div className='w-full 3xl:max-w-[1400px] px-0 3xl:px-0'>
        ...
        <div className='xl:w-[40%] relative'>
          ...
          <div className='relative h-[500px] xl:h-[600px] xl:-mt-[100px]'>
            <Image
            ...
            />
            {/* Overlay text card */}
            <div className='absolute bottom-8 left-4 xl:left-8 w-[250px] bg-[#FFE5A27A] rounded-lg p-4' style={{opacity: 0.48}}>
        ...
        <div className='xl:w-[60%] py-16 px-7 xl:px-28'>
          ...
          <p className='text-white text-[16px] mb-6'>
            Schools are expected to build future-ready learners. We make that easier by offering:
          </p>
