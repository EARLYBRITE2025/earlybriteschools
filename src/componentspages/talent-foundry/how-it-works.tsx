    ...
    <section className='w-full bg-white py-16 flex justify-center'>
      ...
      <div className='flex flex-col xl:flex-row gap-8 mb-16 items-center'>
        ...
        <div className='xl:w-1/2'>
          ...
          <div className='space-y-4 mb-6'>
            <div className='flex items-start gap-3'>
              ...
              <p className='text-black text-[14px]'>8-week learning cycles</p>
            </div>
            <div className='flex items-start gap-3'>
              <Image src="/images/check-green.svg" width={20} height={20} alt="check" className='mt-1' />
            ...
            <div className='flex items-start gap-3'>
              <Image src="/images/check-green.svg" width={20} height={20} alt="check" className='mt-1' />
              <p className='text-black text-[14px]'>Delivered as electives, clubs, or after-school programs</p>
            </div>
            <div className='flex items-start gap-3'>
              <Image src="/images/check-green.svg" width={20} height={20} alt="check" className='mt-1' />
              <p className='text-black text-[14px]'>Led by certified mentors in collaboration with school staff</p>
            </div>
            <div className='flex items-start gap-3'>
              <Image src="/images/check-green.svg" width={20} height={20} alt="check" className='mt-1' />
              <p className='text-black text-[14px]'>Project showcase at the end of every cycle</p>
            </div>
          </div>
        ...
        <div className='xl:w-1/2 relative min-h-[400px]'>
          <Image
            src="/images/talent-how-it-works.png"
            fill
      ...
      <div className='flex flex-col xl:flex-row gap-8'>
        ...
        <div className='xl:w-1/2'>
          ...
          <div className='space-y-4 mb-6'>
            <div className='flex items-start gap-3'>
              <Image src="/images/check-green.svg" width={20} height={20} alt="check" className='mt-1' />
              <p className='text-black text-[14px]'>Digital creation and problem-solving abilities</p>
            </div>
            <div className='flex items-start gap-3'>
              <Image src="/images/check-green.svg" width={20} height={20} alt="check" className='mt-1' />
              <p className='text-black text-[14px]'>Confidence to express and collaborate</p>
            </div>
            <div className='flex items-start gap-3'>
              <Image src="/images/check-green.svg" width={20} height={20} alt="check" className='mt-1' />
              <p className='text-black text-[14px]'>Real exposure to industries and role models</p>
            </div>
            <div className='flex items-start gap-3'>
              <Image src="/images/check-green.svg" width={20} height={20} alt="check" className='mt-1' />
              <p className='text-black text-[14px]'>Recognition through certificates and portfolios</p>
            </div>
            <div className='flex items-start gap-3'>
              <Image src="/images/check-green.svg" width={20} height={20} alt="check" className='mt-1' />
              <p className='text-black text-[14px]'>Early clarity about strengths and career paths</p>
            </div>
          </div>
      ...
      <section className='w-full bg-black py-16 flex justify-center'>
        ...
        <div className='flex flex-col xl:flex-row gap-8'>
          ...
          <div className='xl:w-1/2 relative min-h-[400px]'>
            <Image
              src="/images/talent-what-school.png"
              fill
          ...
          <div className='xl:w-1/2'>
            ...
            <div className='space-y-4 mb-6'>
              <div className='flex items-start gap-3'>
                <Image src="/images/check-green.svg" width={20} height={20} alt="check" className='mt-1' />
                <p className='text-white text-[14px]'>More engaged students</p>
              </div>
              <div className='flex items-start gap-3'>
                <Image src="/images/check-green.svg" width={20} height={20} alt="check" className='mt-1' />
                <p className='text-white text-[14px]'>Modern skill development without extra burden on teachers</p>
              </div>
              <div className='flex items-start gap-3'>
                <Image src="/images/check-green.svg" width={20} height={20} alt="check" className='mt-1' />
                <p className='text-white text-[14px]'>Opportunities to participate in competitions and tech tour</p>
              </div>
              <div className='flex items-start gap-3'>
                <Image src="/images/check-green.svg" width={20} height={20} alt="check" className='mt-1' />
                <p className='text-white text-[14px]'>Positive reputation with parents and the community</p>
              </div>
              <div className='flex items-start gap-3'>
                <Image src="/images/check-green.svg" width={20} height={20} alt="check" className='mt-1' />
                <p className='text-white text-[14px]'>Structured support for future-readiness goals</p>
              </div>
            </div>
          ...
          <div className='flex flex-col-reverse xl:flex-row xl:items-end'>
            ...
            <div className='xl:w-[50%] p-8 xl:p-12'>
              ...
              <div className='space-y-4'>
                <div className='flex items-start gap-3'>
                  <Image src="/images/check-green.svg" width={20} height={20} alt="check" className='mt-1' />
                  <p className='text-white text-[14px]'>Co-design the right learning mix</p>
                </div>
                <div className='flex items-start gap-3'>
                  <Image src="/images/check-green.svg" width={20} height={20} alt="check" className='mt-1' />
                  <p className='text-white text-[14px]'>Provide approved mentors and facilitators</p>
                </div>
                <div className='flex items-start gap-3'>
                  <Image src="/images/check-green.svg" width={20} height={20} alt="check" className='mt-1' />
                  <p className='text-white text-[14px]'>Offer training for your staff if needed</p>
                </div>
                <div className='flex items-start gap-3'>
                  <Image src="/images/check-green.svg" width={20} height={20} alt="check" className='mt-1' />
                  <p className='text-white text-[14px]'>Integrate seamlessly into the school calendar</p>
                </div>
              </div>
            </div>
