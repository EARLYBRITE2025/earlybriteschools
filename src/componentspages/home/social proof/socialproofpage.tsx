...
const Socialproofpage = ({ bg = "bg-white" }: Props) => {
  useEffect(() => {
  ...
  return (
    <main className="bg-[#00914721] w-full py-10 flex items-center justify-center">
      <div className="w-full 3xl:max-w-[1400px] px-7 xl:px-28 3xl:px-0">
        <section
          className={`social-section  min-h-[600px] md:min-h-[700px] lg:min-h-[800px] xl:min-h-[918px] w-full flex-col rounded-2xl flex items-center py-10 px-5 ${bg}`}
        >
          <div className="text-[#000000] space-y-5 flex items-center justify-center flex-col w-full">
            ...
            <div className="social-tabs">
              <div className="bg-white p-[6px] sm:p-[8px] items-center rounded-full gap-[10px] sm:gap-[14px] flex w-[160px] sm:w-[192px] shadow-md">
                ...
                <div className="text-[#999999] text-[16px] sm:text-[18px] md:text-[20px]">
                  Text
                </div>
              </div>
            </div>
