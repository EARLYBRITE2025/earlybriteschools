...
const About = () => {
  return (
    <div
      className="bg-[#FFFFFF] about-style flex-col md:h-auto lg:h-auto pb-20 lg:gap-10 lg:flex-row lg:justify-center xl:justify-center items-start pt-10 md:px-10 lg:px-20 md:justify-center flex justify-center w-full px-5 pt-20 space-y-10"
      id="about"
    >
