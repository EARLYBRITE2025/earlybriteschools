...
const Contact = () => {
  ...
  return (
    <section
      className="w-full flex justify-center  md:py-[60px] md:bg-linear-to-r from-[#E1F5FE] to-[#FFF0CC]"
      id="contact"
    >
      <div className="w-full 3xl:max-w-[1400px] px-7 xl:px-28 3xl:px-0">
        <div className="bg-[#0F151E] w-full min-h-[700px] md:min-h-[450px] lg:min-h-[452px]  flex flex-col gap-10 md:gap-[60px] lg:gap-[100px] rounded-2xl md:flex-row md:justify-between md:items-stretch">
          {/* LEFT TEXT SIDE */}
          <div className="gap-6 sm:gap-8 md:gap-10 py-10 px-10 flex flex-col w-full md:w-1/2">
            <h1 className="contact-heading w-full max-w-[322px] sm:max-w-[380px] md:max-w-[420px] lg:max-w-[454px] text-[32px] sm:text-[38px] md:text-[44px] lg:text-[52px] xl:text-[56.62px] font-[family-name:var(--font-baloo2)] font-bold text-[#FFFFFF]">
              Let&apos;s build the{" "}
              <strong className="text-[#009147]">future</strong> together.
            </h1>
            ...
            <p className="contact-text w-full max-w-[322px] sm:max-w-[380px] md:max-w-[420px] lg:max-w-[454px] text-[14px] sm:text-[15px] md:text-[16px] lg:text-[17px] xl:text-[18.87px] text-[#FFFFFF]">
              Whether you&apos;re a parent, student, or educator, there&apos;s a
              place for you at Earlybrite.
            </p>

            <div className="gap-4 sm:gap-5 flex flex-wrap">
          ...
          {/* RIGHT IMAGE SIDE */}
          <div className="relative flex w-full md:w-1/2 justify-center items-end min-h-[335px] md:min-h-[350px] overflow-hidden">
            ...
            <div className="absolute inset-0 hidden md:flex items-center justify-end pointer-events-none">
              <Image
                src="/images/contact-layer.png"
                width={506.39}
                height={846.92}
                alt="decorative pattern"
                className="contact-bg-img absolute md:right-[-75] lg:right-0 w-auto top-0  object-contain opacity-100"
              />
            </div>
            ...
            <Image
              ...
              className="contact-student-img absolute bottom-0 z-2 hidden md:flex w-[550px] lg:w-[380px] object-contain"
            />
            ...
            <Image
              ...
              height={804.22}
              alt="student contact image"
              className="contact-student-img bottom-0 absolute z-2 md:hidden w-auto h-[350px] object-contain"
            />
            ...
            <Image
              ...
              height={329.71}
              alt="layer shape"
              className="contact-layer absolute bottom-0 z-1 hidden lg:flex w-auto h-[200px] lg:h-[250px] object-contain"
            />
          </div>
        </div>
      </div>
