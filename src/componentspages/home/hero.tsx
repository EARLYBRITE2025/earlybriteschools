      ...
      >
        <div className="hero-first-div w-full 3xl:max-w-[1400px] px-7 xl:px-28 3xl:px-0">
          <div className="hero-div flex flex-col space-y-5 justify-center items-center w-full md:items-start">
            ...
            <div className="flex items-center gap-3  w-full justify-between md:justify-start flex-wrap">
              <button className="bg-[#F9BB1E] button flex-[.45] text-[12px] font-medium sm:text-[16px]">
                Explore Program
              </button>
              <button className="bg-[#1A94D2] button flex-[.45] text-white text-[14px] sm:text-[16px]">
          ...
          <div className="flex image-container items-center mt-5 md:mt-0 w-full md:w-auto overflow-y-hidden h-[300px] sm:h-[350px] md:h-[403px] lg:h-[481px] xl:w-[603px] xl:h-[603px] overflow-x-auto no-scrollbar pl-5 md:pl-0 gap-5 snap-x snap-mandatory">
            {/* First image */}
            <div className="shrink-0 overflow-hidden rounded-2xl w-[85%] md:w-full  snap-start">
              <Image
