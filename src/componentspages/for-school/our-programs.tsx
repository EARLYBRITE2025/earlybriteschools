...
<main className='bg-[#F2F2F2] p-[40px] flex flex-col items-center justify-center gap-[16px]'>
    ...
    <div className='flex flex-col xl:flex-row items-center xl:justify-between  gap-[16px] justify-start'>
       <div className='flex flex-col items-center justfiy-center  gap-[40px]'>
         <h1 className='text-[24px] font-bold xl:w-[px] text-[#000000]'>The Elite Mentorship Program (TEMP)</h1>
        <p className='text-[#666666] xl:w-[433px]'>TEMP is a transformative youth mentorship and development program that helps schools guide students toward discovering their potential and building 21st-century skills.</p>
