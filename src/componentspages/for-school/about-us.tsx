...
const ForSchoolPage = () => {
  ...
  return (
    <main className="bg-[#00914780] w-full py-10 flex items-center justify-center" id="about">
      <section className="social-section bg-[#009147] h-[714.8545532226562px] md:h-[918px] md:w-[1200px] flex-col rounded-2xl flex items-center w-[322px]">
        <div className="text-[#000000] space-y-5 flex items-center justify-center pt-10 flex-col">
          ...
          <div className="social-tabs">
            <div className="bg-[#80C8A380] p-[8px] items-center rounded-full gap-[14px] flex w-[192px] ">
              <div
              ...
              <div className="text-[#666666] text-[20px]">Text</div>
            </div>
          </div>
