...
/>
    ...
    <div className='flex flex-col xl:flex-row  xl:mt-[50px] items-center  gap-[16px] justify-start '>
       ...
       <ul className='flex flex-col  w-[352px]  xl:w-[433px] px-[10px]  text-[#666666] gap-[18px] items-start justify-start text-[18px] xl:items-center xl:justify-center  '>
                      <li className='flex gap- items-start justify-start w-[302px]  xl:w-[433px] '>
    ...
    <div className='flex flex-col xl:flex-row  xl:mt-[50px] items-center  gap-[16px] justify-start'>
       ...
       <ul className='flex flex-col  xl:w-[433px]  text-[#666666] gap-[18px] items-start justify-start text-[18px] '>
             ...
             <Image  src="/svg/check.svg"
                   ...
                   width={24}
                   height={24}                                
                  />    <p  className='text-[18px] w-[256px] xl:w-[387px]'> Add value to your early years or primary program through experiential learning.</p>
                      </li>
                      <li className='flex gap-[22px]  items-start justify-start w-[302px]  xl:w-[433px]'>
               <Image  src="/svg/check.svg"
                   alt=''
                   width={24}
                   height={24}                                
                  />   <p  className='text-[18px] w-[256px] xl:w-[387px]'> Increase enrollment and parent satisfaction with creative, purposeful play.</p>
                      </li>
                      <li className='flex gap-[22px]  items-start justify-start w-[302px]  xl:w-[433px]'>
                 <Image  src="/svg/check.svg"
                   alt=''
                   width={24}
                   height={24}                                
                  /> <p  className='text-[18px] w-[256px] xl:w-[387px]'>Receive training and resources for your teachers to deliver world-class sessions.</p>
                      </li>
                      <li className='flex gap-[22px]  items-start justify-start w-[302px]  xl:w-[433px]'>
                 <Image  src="/svg/check.svg"
                   alt=''
                   width={24}
                   height={24}                                
                  />  <p  className='text-[18px] w-[256px] xl:w-[387px]'> Showcase your school as a model for modern, child-centered education.</p>
                      </li>
                  </ul>
             <div className='flex items-center space-x-3 w-full md:justify-center justify-start whitespace-nowrap md:justify-start' >
                      <button className='bg-[#1A94D2] w-[212px]  reuseable-button px-5 '  ><span className='flex px-3 items-center group justify-center text-white '>Talk to US <WhiteRightarrowSvg/></span></button>        
