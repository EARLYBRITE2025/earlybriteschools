    ...
    <div className='flex flex-col xl:flex-row  xl:mt-[50px] items-center   gap-[16px] justify-start'>
       ...
       <ul className='flex flex-col     xl:w-[433px]  text-[#666666] gap-[18px] items-start justify-start text-[18px]  '>
                  ...
                  <Image  src="/svg/check.svg"
                   ...
                   width={24}
                   height={24}                                
                  />  <p className='text-[18px] w-[256px] xl:w-[387px]'> Give your students real-world international exposure.</p>
                      </li>
                      <li className='flex gap-[22px]  items-start justify-start w-[302px]  xl:w-[433px] '>
                  <Image  src="/svg/check.svg"
                   alt=''
                   width={24}
                   height={24}                                
                  />  <p className='text-[18px] w-[256px] xl:w-[387px]'> Strengthen your school's global reputation through exchange opportunities.</p>
                      </li>
                      <li className='flex gap-[22px]  items-start justify-start w-[302px]  xl:w-[433px] '>
                   <Image  src="/svg/check.svg"
                   alt=''
                   width={24}
                   height={24}                                
                  />  <p  className='text-[18px] w-[256px] xl:w-[387px]'> Connect your curriculum to real global industries.</p>
                      </li>
                      <li className='flex gap-[22px]  items-start justify-start w-[302px]  xl:w-[433px] '>
                  <Image  src="/svg/check.svg"
                   alt=''
                   width={24}
                   height={24}                                
                  /> <p  className='text-[18px] w-[256px] xl:w-[387px]'> Build pride and visibility by having your students represent your school abroad.</p>
                      </li>
                  </ul>
             <div className='flex items-center mt-[16px] w-full md:justify-center justify-start whitespace-nowrap md:justify-start' >
                      <button onClick={()=> router.push("/git")}  className='bg-[#1A94D2] w-[212px]  reuseable-button px-5 '  ><span className='flex px-3 items-center group justify-center text-white '>Talk to US <WhiteRightarrowSvg/></span></button>        
