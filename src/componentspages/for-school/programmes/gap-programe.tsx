       ...
       <ul className='flex flex-col   w-[352px]  xl:w-[433px]  text-[#666666] gap-[18px] items-start justify-start text-[18px]  '>
                    ...
                    <Image
                         src="/svg/check.svg"
                            ...
                            width={24}
                            height={24}                                
                            />     <p className='text-[18px] w-[256px] xl:w-[387px]'>   Offer a next-step solution for your graduates and parents.</p>
                      </li>
                      <li className='flex gap-[22px]  items-start justify-start w-[302px]  xl:w-[433px] '>
                   <Image
                         src="/svg/check.svg"
                            ...
                            width={24}
                            height={24}                                
                            />    <p className='text-[18px] w-[256px] xl:w-[387px]'> Strengthen alumni engagement through continuous mentorship.</p>
                      </li>
                      <li className='flex gap-[22px]  items-start justify-start w-[302px]  xl:w-[433px]'>
                    <Image
                         src="/svg/check.svg"
                            ...
                            width={24}
                            height={24}                                
                            />    <p className='text-[18px] w-[256px] xl:w-[387px]'> Position your school as one that supports holistic student growth.</p>
                      </li>
                      <li className='flex gap-[22px]  items-start justify-start w-[302px]  xl:w-[433px]'>
                      ...
                      <Image
                         src="/svg/check.svg"
                            ...
                            width={24}
                            height={24}                                
                            />  <p className='text-[18px] w-[256px] xl:w-[387px]'> Partner with Earlybrite to co-brand certificates and portfolio showcases.</p>
                      </li>
                  </ul>
             <div className='flex items-center space-x-3 w-full md:justify-center justify-start whitespace-nowrap md:justify-start' >
                      <button onClick={()=> router.push("/gap")}  className='bg-[#1A94D2] w-[212px]  reuseable-button px-5 '  ><span className='flex px-3 items-center group justify-center text-white '>Talk to US <WhiteRightarrowSvg/></span></button>        
