    ...
    <div className='flex flex-col xl:flex-row  xl:mt-[50px] items-center  gap-[16px] justify-start hidden md:flex'>
       ...
       <ul className=' flex flex-col     xl:w-[433px]  text-[#666666] gap-[18px] items-start justify-start text-[18px]'>
                ...
                <Image
                      ...
                      width={24}
                      height={24}                                
                    />     <p className='text-[18px] w-[256px] xl:w-[387px]'> Keep your students engaged and productive during the holiday.</p>
                      </li>
                      <li className='flex gap-[22px]  items-start justify-start w-[302px]  xl:w-[433px] '>
               <Image
                       src="/svg/check.svg"
                      ...
                      width={24}
                      height={24}                                
                    />         <p className='text-[18px] w-[256px] xl:w-[387px]'>Offer added value to parents through structured summer learning.</p>
                      </li>
                      <li className='flex gap-[22px]  items-start justify-start w-[302px]  xl:w-[433px]'>
                <Image
                       src="/svg/check.svg"
                      ...
                      width={24}
                      height={24}                                
                    />       <p className='text-[18px] w-[256px] xl:w-[387px]'> Strengthen your community presence and reputation for excellence.</p>
                      </li>
                      <li className='flex gap-[22px]  items-start justify-start w-[302px]  xl:w-[433px] '>
              <Image
                       src="/svg/check.svg"
                      ...
                      width={24}
                      height={24}                                
                    />      <p className='text-[18px] w-[256px] xl:w-[387px]'> Enjoy access to mentorship, workshops, and festival events for your students.</p>
                      </li>
                  </ul>
             <div className='flex items-center space-x-3 w-full md:justify-center justify-start whitespace-nowrap md:justify-start' >
                      <button className='bg-[#1A94D2] w-[212px]  reuseable-button px-5 '  ><span className='flex px-3 items-center group justify-center text-white '>Talk to US <WhiteRightarrowSvg/></span></button>        
